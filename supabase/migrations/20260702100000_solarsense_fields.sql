...
alter table public.products
  add column module_type text not null default 'mono'
    check (module_type in ('mono', 'poly', 'thin')),
  add column mounting text not null default 'roof'
    check (mounting in ('roof', 'ground', 'track')),
