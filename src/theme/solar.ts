// ----------------------------------------------------------------------
// SolarSense design tokens — shared across auth and dashboard pages.
...
// App-shell tokens for the signed-in pages (Projects, Project detail).
export const solarApp = {
  pageBg: '#FBF8F1', // app background
  topBarBorder: '#EFEADD', // top bar bottom border + card dividers
  cardBorder: '#EEE8DA', // card outline
  cardBorderHover: '#E4DCC8',
  chipBorder: '#EAE4D6', // filter chips / lang button border
  chipHover: '#F7F3EA',
  subtitle: '#7A7362', // page subtitles
  label: '#A39B87', // stat labels, "updated" text
  chipText: '#6B6455',
  chipCount: '#9A9280',
} as const;
