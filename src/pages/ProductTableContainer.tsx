...
/** Shape of the editable product form. Values may be strings (raw input) or numbers (from existing product). */
...
const ProductTableContainer = (props: ProductTableContainerProps) => {
  ...
  const [newCreatedProduct, setNewCreatedProduct] = useState<boolean>(true);
  const [editData, setEditData] = useState<Partial<ProductFormFields>>({});
  ...
  const productVisualizationHandle = useCallback(
  ...
  return (
    <>
      ...
      <TableContainer component={Paper}>
        <Table sx={{ minWidth: 700, border: '1px solid #48B2E3' }} aria-label="customized table">
          <TableHead>
            <TableRow>
